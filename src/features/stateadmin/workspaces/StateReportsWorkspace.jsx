...
const COLUMNS = {
  ...
  projects: [
    { key: 'id', label: 'Project ID', hideOn: 'sm' },
    { key: 'name', label: 'Name' },
    { key: 'department', label: 'Department' },
    { key: 'cost', label: 'Estimated Cost', render: (r) => formatAmount(r.cost) },
    { key: 'sanctionedAmount', label: 'Sanctioned', render: (r) => (r.sanctionedAmount ? formatAmount(r.sanctionedAmount) : '—'), hideOn: 'md' },
  ...
  proposals: [
    { key: 'id', label: 'Proposal ID', hideOn: 'sm' },
    { key: 'purpose', label: 'Purpose' },
    { key: 'department', label: 'Department' },
    { key: 'cost', label: 'Estimated Cost', render: (r) => formatAmount(r.cost) },
    { key: 'workflowId', label: 'Workflow', hideOn: 'md' },
  ...
  orders: [
    ...
    { key: 'version', label: 'Version', hideOn: 'md' },
  ...
  audit: [
    { key: 'id', label: 'Event ID', hideOn: 'sm' },
    { key: 'action', label: 'Action' },
    { key: 'entity', label: 'Entity' },
    { key: 'entityId', label: 'Entity ID', hideOn: 'md' },
    { key: 'actor', label: 'Actor', hideOn: 'md' },
    { key: 'timestamp', label: 'Timestamp', render: (r) => formatDateTime(r.timestamp) },

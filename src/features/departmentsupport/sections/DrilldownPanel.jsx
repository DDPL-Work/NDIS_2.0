...
import { mapFacilityForAction, mapPriorityForAction } from '../../admin/facilityActions/facilityActionMapper'
import FacilityActionMenu from '../../admin/facilityActions/FacilityActionMenu'
...
export default function DrilldownPanel({ entity, config, onClose, onAction }) {
  ...
  // Map entity to normalized facility model for the action system
  const normalizedFacility = mapFacilityForAction(entity, priority)
  const normalizedPriority = mapPriorityForAction(priority)

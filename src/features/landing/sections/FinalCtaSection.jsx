      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="ndisp-scroll-reveal relative overflow-hidden rounded-3xl bg-ink-950 px-6 py-14 text-center sm:px-12">
          ...
          <div className="relative">
            ...
            <h2 className="mx-auto mt-4 max-w-2xl font-display text-3xl font-bold tracking-tight text-white sm:text-4xl">Ready to Explore Your District?</h2>
            <p className="mx-auto mt-3 max-w-xl text-[14.5px] leading-relaxed text-ink-300">Find services near you, report what needs attention and follow every request to its resolution.</p>

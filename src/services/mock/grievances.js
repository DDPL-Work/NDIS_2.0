...
const ISSUE_TEMPLATES = {
  ...
  urban: ['Unmaintained heritage site approach road', 'Encroachment near heritage buffer', 'Overflowing garbage dump', 'Drain blockage and sanitation'],
  electricity: ['Installed panels non-functional', 'Grid connection pending for months', 'Transformer failure / Power outage', 'Street light outage'],
  pwd: ['Pothole cluster on village road', 'Public building in disrepair', 'Encroachment on public land', 'Bridge railing damage'],
}

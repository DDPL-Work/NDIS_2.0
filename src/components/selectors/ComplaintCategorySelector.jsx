...
export default function ComplaintCategorySelector({ value, onChange, small, disabled, className, showAll = false, allLabel = 'All Categories' }) {
  const { data: categories, loading, error } = useComplaintCategories()

...
export default function Badge({ tone = 'neutral', children, className, dot, style }) {
  return (
    <span className={clsx('inline-flex items-center gap-1.5 rounded-full px-2 py-0.5 text-[11.5px] font-semibold max-w-full', TONES[tone] || TONES.neutral, className)} style={style}>
